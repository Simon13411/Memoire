...
LEFT OUTER JOIN (SELECT SG."name", SG."id_sc" FROM "Scientific" SG ) as genSC ON G.id_sc=genSC."id_sc"
LEFT OUTER JOIN (SELECT SSG."name", SSG."id_sc" FROM "Scientific" SSG ) as subgenSC ON Sg.id_sc=genSC."id_sc"
LEFT OUTER JOIN (SELECT SS."name", SS."id_sc" FROM "Scientific" SS ) as speSC ON S.id_sc=genSC."id_sc"
LEFT OUTER JOIN (SELECT SSS."name", SSS."id_sc" FROM "Scientific" SSS ) as subspeSC ON Ss.id_sc=genSC."id_sc"
"""
